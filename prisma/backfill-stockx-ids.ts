...
const { prisma } = nodeRequire(path.join(baseDir, 'utils', 'prisma')) as typeof import('../src/utils/prisma')
const { fetchWithAuth } = nodeRequire(path.join(baseDir, 'utils', 'stockxAuth')) as typeof import('../src/utils/stockxAuth')
